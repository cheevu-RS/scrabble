        ...
        return (
            <div>
                ...
                <div className="rules">
                    ...
                    <p>
                        {' '}
                        Games only have two players. Each match has two games, one
                        with each player playing first.{' '}
                    </p>
                    <p>
                        {' '}
                        Players initially draw 7 tiles each and place them on their
                        rack.{' '}
                    </p>
                    <p>
                        {' '}
                        The first player combines two or more of his or her letters
                    ...
                    <p>
                        {' '}
                        After playing a word, the player receives replacement
                        letters, one for each letter played.{' '}
                    </p>
                    <p>
                        {' '}
                        Following the first turn, players alternate. Each plays a
                    ...
                    <p>
                        {' '}
                        The letters placed in a single turn must all be in a single
                    ...
                    <ul>
                        <li>
                            {' '}
                            All of the letters are either in the player&apos;s racks
                            or on the board, and one player uses his or her last
                            letter or
                        </li>
                        <li>
                            {' '}
